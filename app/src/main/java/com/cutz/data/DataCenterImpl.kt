...
import com.cutz.data.remote.repository.ApiRepository
...
class DataCenterImpl @Inject constructor(
    ...
    override suspend fun getOffers(lang: String, token: String): Response<ProductsResponse> = apiRepository.getOffers(lang,token)
