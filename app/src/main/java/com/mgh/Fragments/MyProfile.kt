...
import com.mgh.Model.Profile_Response
import com.mgh.R
import com.mgh.ViewModel.EditProfile_ViiewModel
...
import kotlinx.android.synthetic.main.fragment_my_profile.view.toolbarhome
...
//        root.progressBarLogin.visibility = View.VISIBLE
        ...
        Prof_ViewModel.getData(
            ...
            Observer<Profile_Response> { loginmodel ->
                Loading.Disable()
                if (loginmodel != null) {
                    root.E_NameProfile.setText(loginmodel.data.name)
