package com.cutzegypt.data.remote.repository
...
class ApiRepository @Inject constructor(private val apiService: ApiService) : ApiService {
    ...
    override fun getBranches(language: String): Call<BranchesResponse> = apiService.getBranches(language)
    ...
    override suspend fun getOffers(language: String, token: String,  map: Map<String, String>): Response<ProductsResponse>
    = apiService.getOffers(language,token,map)
