...
import com.cutzegypt.databinding.FragmentProductsByIdBinding
   ...
   fun initAdapter(){
    ...
    private fun getData() {
        ...
        if(type.equals("sectionID")){
            detailsSections = bundle.getParcelable("cat")!!
            mViewModel.Id.value=detailsSections.id.toString()
            mViewDataBinding.TName.text=detailsSections.title
