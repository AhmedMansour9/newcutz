...
import com.cairocart.Adapter.SubCategories_Adapter
...
class SubCategories : Fragment() , ProductBytUd_View {
    ...
    var bundle= Bundle()
    lateinit var details: Categories_Response.Data.ChildrenData
...
//        root.recycler_Categroies.adapter=listAdapter
    ...
    override fun Sub_Id(subcategories: Categories_Response.Data.ChildrenData) {
