...
////
    ...
    @POST("categories")
    fun Categories(
        @QueryMap map:Map<String,String>,@Header("X-localization")lang:String): Call<Categories_Response>
    ...
    @POST("all_notificaitons")
    fun Notigications(): Call<AllNotifications_Response>
