...
class SubCategories_Adapter (context: Context, val userList: List<Categories_Response.Data.Data.Subcategory>)
    ...
    override fun onBindViewHolder(holder: SubCategories_Adapter.ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(){
            this.productbyid.Sub_Id(userList.get(position))
        }
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(dataModel: Categories_Response.Data.Data.Subcategory) {
